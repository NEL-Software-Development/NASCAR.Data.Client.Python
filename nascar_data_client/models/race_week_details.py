...
class RaceWeekDetails(object):
    ...
    def __init__(self, id=None, races=None):  # noqa: E501
        """RaceWeekDetails - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._races = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RaceWeekDetails, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RaceWeekDetails):
            return False
